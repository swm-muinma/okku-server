        ...
        try {
            List<MessageContent> system = List.of(
                    new TextMessageContent("입력된 사람 이미지가 당사의 정책에 위반되는지를 판단하는 전문 검수자입니다.\n" +
                            "'100% 확실하게 정책에 해당하는 번호만' 선택하고, 선택한 이유와 함께 반환합니다.\n" +
                            ...
                            "3. 사람의 앞모습이 보이지 않습니다.\n" +
                            "4. 가장 큰 사람과 두 번째로 큰 사람의 크기가 같습니다.\n" +
                            "5. 팔, 다리가 상의를 40%이상 가리고 있어 상의를 명확히 인식할 수 없습니다.\n"+
                            "6. 팔, 다리가 하의를 40%이상 가리고 있어 하의를 명확히 인식할 수 없습니다.\n"+
                            "7. 가방, 목걸이, 커피, 휴대폰이 상의를 40%이상 가리고 있어 상의를 명확히 인식할 수 없습니다.\n"+
                            "8. 가방, 목걸이, 커피, 휴대폰이 하의를 40%이상 가리고 있어 하의를 명확히 인식할 수 없습니다.\n"+
